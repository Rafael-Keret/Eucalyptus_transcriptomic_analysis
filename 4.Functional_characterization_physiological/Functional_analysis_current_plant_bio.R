...
# Functional analysis of the differentially expressed genes associated with xylem physiological responses in E. grandis subject to control and droughted conditions.
# Author: Rafael Keret
